...
class EasyVc {
	...
	async createVM(vmName, isoPath, autounattendIsoPath, datastoreName, networkName, networkType, esxiIp) {
		...
		async function initNetwork() {
			...
			//console.log('=========================')
			//console.log(virtualE1000.addressType)
			//console.log('=========================')
	...
	async createImportSpec(vmName, ovfContent, hostMor, datastoreMor, networkMor, resourePoolMor, vidm, ad) {
		let svc = await this._service()
		let vim = svc.vim
		let vimPort = svc.vimPort
